...
public class  objectDetectorClass {
    private static final String TAG="ObjectDetectorClass";
    ...
    objectDetectorClass(AssetManager assetManager,String handModel,String labelPath,int inputSize,String classification_model,int classification_input_size) throws IOException{
